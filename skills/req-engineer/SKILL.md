...
**What counts as requirements engineering**: Full 2-3 round interview + The Grill (Step 3.5) + prototype walkthrough choice + `requirements.md` with prototypes.
...
**Completion gate:** You MUST NOT proceed to Step 4 (Domain Research) or Step 5 (Generate requirements.md) until:
...
**How to verify this gate:** Before writing requirements.md, check: "Did I run The Grill and get user responses?" If NO → stop and run it now. There is no valid reason to skip this step.
